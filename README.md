...
Мод посвящен созданию розовых цыплят и цып в Minecraft, в дальнейшем как отдельной сущности,а на данной версии за счёт Курицы (Chicken)

## Что изменяет мод
Это не текстурпак, обычные курицы и цыплята остаются (что видно на скрине), но помимо них добавляются мои розовые версии
